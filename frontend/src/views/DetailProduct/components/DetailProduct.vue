        ...
        <div class="col-lg-6 col-md-6">
          <div class="product__details__pic">
            ...
            <div class="product__details__pic__slider owl-carousel">
              ...
              />
              <img
                data-imgbigurl="dist/img/product/details/product-details-3.jpg"
                src="dist/img/product/details/thumb-2.jpg"
                alt=""
              />
              <img
                data-imgbigurl="dist/img/product/details/product-details-5.jpg"
                src="dist/img/product/details/thumb-3.jpg"
                alt=""
              />
              <img
                data-imgbigurl="dist/img/product/details/product-details-4.jpg"
...
export default {
  computed:{
    ...mapState(["currentProductUniqueId","currentProduct","currentCategoryUniqueId"])

  },
  created(){
    this.$store.commit("setCurrentProductUniqueId",this.$route.params.unique_id)
    this.$store.dispatch("loadCurrentProduct",this.$route.params.unique_id);

  },
    watch:{
      currentProduct : function(){
        this.$store.dispatch("loadCurrentCategory",this.currentCategoryUniqueId);
      },
    $route(to, from) {
      this.$store.commit("setCurrentProductUniqueId",to.params.unique_id)
      if(this.currentProductUniqueId){
        this.$store.dispatch("loadCurrentProduct",this.currentProductUniqueId);
      }
  ...
  //   return{
  //     currentProduct:[],
  //     currentUniqueId:this.$route.params.unique_id,
  //   }
  // },
  // watch:{
  //   $route(to, from) {
  //     this.currentUniqueId=to.params.unique_id
  ...
  // methods:{
  //   getCurrentProduct(){
  //     this.$http.get("http://localhost/api/products/"+this.currentUniqueId)
  //     .then((response) => {
